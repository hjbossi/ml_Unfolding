...
void RooSimplepTPbPb_split_FromML(TString cFiles2="filesML.txt")
{
#ifdef __CINT__
  ...
  TH2F *effdenom=(TH2F*)h1fulleff->Clone("effdenom");
   ...
   TFile *input2=TFile::Open("/home/hbossi/alidock/ml-background/PredictionTrees/predictionTree_AreaBased_For_LHC16j5_Embedded_R040.root");
   TTree *mc=(TTree*)input2->Get("predictionTree_AreaBased_LHC16j5_Embedded_R040"); 
   ...
   for(int iEntry=0; iEntry< nEv; iEntry++){
    ...
    TFile *fout=new TFile (Form("UnfoldingSplit_AreaBased_R04_Pass2_Mar5th.root"),"RECREATE");
    fout->cd();
    h1raw->SetName("raw");
    h1raw->Write();
...
#ifndef __CINT__
int main () { RooSimplepTPbPb_split_FromML(); return 0; }  // Main program when run stand-alone
#endif
